   ...
   async function copy(id,indx)
    ...
    return (
        <div class="dashboard-header11">
            ...
            {loading ? <div className="d-flex flex-column justify-content-center align-items-center" style={{height:"400px"}}><CircularProgress style={{'color': 'white'}}/><p className="my-2 text-white">Fetching your Orders...</p></div> :
