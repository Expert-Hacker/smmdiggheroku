...
import {Alert, Button,Checkbox,  FormControl,  IconButton,  InputLabel,  MenuItem,  Select,  TextField, Tooltip} from '@mui/material';
...
function Neworder() {
    ...
    const createOrder =async(e)=>{
        ...
        // if(totalCharge==0)
        // {
        //   return toast.error(`Total charge must be non-zero`, {
        ...
        // if(totalCharge<0)
        // {
        //   return toast.error(`Quantity must be positive number`, {
        //         position: "bottom-center",
        //         autoClose: 3500,
        //         draggable: false,
        //         }); 
   ...
   async function fetchservicesWhenpageLoads(serv)
    ...
    return (
        <div className="overflow overflow1 dashboard-header11 ">
            ...
            <div className="neworder container ml-auto mr-auto row">
            {/* <div className='whatsappChatDiv'>
                ...
                <div className="left_neworder  col-sm container">
                        ...
                        {/* <FormControl fullWidth className="my-3"> */}
                            ...
                            <select size='small'  label="Select Category" onChange={handlecategoryChanges} className="form-control" 
                            >
                                {
                        ...
                        {/* <FormControl fullWidth className="my-3"> */}
                            ...
                            <select size='small' label="Select Service" className="form-control" name="" id="sel_service" onChange={handleServicechanged}>
                        ...
                        <div>
                        <InputLabel className=" text-white">Description</InputLabel>
                            <TextField multiline className="serv_desc00" value={desc} rows="6"  className="form-control" disabled maxRows={10}/> 
                        </div>
                        <div className="my-3 linksss">
                            <InputLabel className=" text-white">Enter Link <span className="text-danger">*</span></InputLabel>
                            <TextField error={linkError} helperText={linkError ? "Please enter the link" : ""} size="small" autoComplete="false" className="form-control" value={link.text} name="text" placeholder="https://" onChange={handleLinkchanage} type="text" />
                        </div>
                      {min==1&&max==1 ? "" : <div className="my-3">
                            ...
                            <div className="d-flex justity-content ">
                                <TextField size="small" error={Qtyerror} helperText={Qtyerror ? "Please enter the quantity" : ""} autoComplete="false" value={qty} onChange={handleQtychange} name="qty" className="w-75 form-control" type="number" fullWidth />
                            </div>
                        ...
                        <div>
                            ...
                            <div className="error">
                                <Button variant="contained" color="warning" className="ml-2 my-2 mr-3" disabled={btndisable} onClick={createOrder}>PLACE ORDER</Button>{submitLoading ? <CircularProgress style={{'color': 'white'}}  className="position-absolute mt-2" /> : ""}
