            ...
            <div className="support my-3 container">
                ...
                <div className="col-sm">
                            ...
                            <div>
                                ...
                                <select className="form-control mb-3" id="subject" onChange={handleChange}>
                            ...
                            </div>
                            {
                                ...
                                <div className="my-3">
                                    ...
                                    <TextField onChange={handlePayment} disabled={disabled} value={payment1} error={paymentError} helperText={paymentError ? "This field cannot blank" : ""} placeholder="Please enter payment mode Eg: UPI/Card/Netbanking" type="text"  className="form-control mb-3" />
                                    <h6  className="text-white">Transaction ID</h6>
                                    <TextField placeholder="please enter Transaction ID" error={TransactionIDError} onChange={handleTransactionID} helperText={TransactionIDError ? "This field cannot blank" : ""} disabled={disabled} type="text"  className="form-control mb-3" />
                                    <h6  className="text-white">Description</h6>
                                    <TextField placeholder="Please write a small description about the issue you're facing."  value={Desc} error={Descerror} onChange={handleDecrChgange} helperText={Descerror ? "This field cannot blank" : ""} disabled={disabled} name="" className="form-control" id="" cols="5" rows="5"></TextField>
                                    <Button disabled={btnDisabled} className="my-2" color="warning" variant="contained" onClick={SubmitTicket}>{btnName}</Button>
                                ...
                                <div>
                                    ...
                                    <input onChange={handleFileupload} required className="form-control mb-3"   type="file" name="myFile" id="" />
                                    <h6  className="text-white">Description</h6>
                                    <TextField placeholder="Please write a small description about the issue you're facing."  value={Desc} error={Descerror} onChange={handleDecrChgange} helperText={Descerror ? "This field cannot blank" : ""} disabled={disabled} name="" className="form-control" id="" cols="5" rows="5"></TextField>
